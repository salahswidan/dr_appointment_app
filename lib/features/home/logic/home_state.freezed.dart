...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  specializationsLoading,TResult Function( List<SpecializationsData?>? specializatioonDataList)?  specializationsSuccess,TResult Function( ApiErrorHandler errorHandler)?  specializationsError,TResult Function( List<Doctors?>? doctorsList)?  doctorsSuccess,TResult Function( ApiErrorHandler errorHandler)?  doctorsError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
return specializationsSuccess(_that.specializatioonDataList);case SpecializationsError() when specializationsError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  specializationsLoading,required TResult Function( List<SpecializationsData?>? specializatioonDataList)  specializationsSuccess,required TResult Function( ApiErrorHandler errorHandler)  specializationsError,required TResult Function( List<Doctors?>? doctorsList)  doctorsSuccess,required TResult Function( ApiErrorHandler errorHandler)  doctorsError,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case SpecializationsLoading():
return specializationsLoading();case SpecializationsSuccess():
return specializationsSuccess(_that.specializatioonDataList);case SpecializationsError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  specializationsLoading,TResult? Function( List<SpecializationsData?>? specializatioonDataList)?  specializationsSuccess,TResult? Function( ApiErrorHandler errorHandler)?  specializationsError,TResult? Function( List<Doctors?>? doctorsList)?  doctorsSuccess,TResult? Function( ApiErrorHandler errorHandler)?  doctorsError,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case SpecializationsLoading() when specializationsLoading != null:
return specializationsLoading();case SpecializationsSuccess() when specializationsSuccess != null:
...
class SpecializationsSuccess implements HomeState {
  const SpecializationsSuccess(final  List<SpecializationsData?>? specializatioonDataList): _specializatioonDataList = specializatioonDataList;
  

 final  List<SpecializationsData?>? _specializatioonDataList;
 List<SpecializationsData?>? get specializatioonDataList {
  final value = _specializatioonDataList;
  if (value == null) return null;
  if (_specializatioonDataList is EqualUnmodifiableListView) return _specializatioonDataList;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SpecializationsSuccess&&const DeepCollectionEquality().equals(other._specializatioonDataList, _specializatioonDataList));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_specializatioonDataList));

@override
String toString() {
  return 'HomeState.specializationsSuccess(specializatioonDataList: $specializatioonDataList)';
}
...
/// Create a copy of HomeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? specializatioonDataList = freezed,}) {
  return _then(SpecializationsSuccess(
freezed == specializatioonDataList ? _self._specializatioonDataList : specializatioonDataList // ignore: cast_nullable_to_non_nullable
